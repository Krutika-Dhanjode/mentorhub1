      ...
      <Card className="w-full max-w-md shadow-lg border-0">
        <div className="p-8">
          <div className="flex items-center justify-center gap-2 mb-6">
            <Image src="/logo1.jpeg" alt="Mentor Mentee Hub logo" width={36} height={36} className="h-9 w-9 rounded-md object-contain" priority/>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            return (<button key={role.id} type="button" onClick={() => setSelectedRole(role.id)} className={`p-3 border rounded ${selectedRole === role.id
